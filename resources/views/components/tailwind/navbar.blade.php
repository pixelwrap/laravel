                    ...
                    @foreach($navbar->menu->items as $item)
                        <a href="{{ $item->link }}"
                            @class([
                               ...
                               'text-gray-950 dark:bg-gray-900 dark:border-gray-900 border-gray-50 dark:text-gray-300 hover:text-white dark:hover:text-gray-950 dark:hover:bg-gray-200 hover:bg-gray-950' => !$item->selected])>
                            @if($item->icon)
