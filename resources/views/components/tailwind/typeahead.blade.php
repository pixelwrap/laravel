<div class="relative" data-typeahead-target="{{$typeahead->id}}"
    ...
    <div
        class="absolute z-10 hidden w-full mt-1 bg-white border border-gray-300 {{$typeahead->roundClasses}} shadow-lg dark:bg-gray-800 dark:border-gray-900 type-ahead-results">
