<div class="w-full bg-white border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700 overflow-hidden {{ $card->classes }} {{$card->roundModeratedClasses}}">
    @if($card->showLabel)
